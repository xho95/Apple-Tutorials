...
class RecipeEditorViewController: UIViewController, RecipeController {

    static let storyboardID = "RecipeEditor"
    static func instantiateFromStoryboard() -> RecipeEditorViewController? {
        let storyboard = UIStoryboard(name: "RecipeEditor", bundle: .main)
        return storyboard.instantiateViewController(identifier: storyboardID) as? RecipeEditorViewController
    }
...
extension RecipeEditorViewController {
